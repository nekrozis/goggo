...
// reads and writes the JSON token store on disk (a save replaces the file
// atomically with mode 0600), and Refresh exchanges the stored refresh token at
// auth.gog.com/token for a new access token.
//
