...
var optionTable = []optionSpec{
	...
	{id: optNoColor, long: "no-color", summary: "Do not use coloring in status messages"},
	{id: optNoUnicode, long: "no-unicode", summary: "Do not use Unicode in the progress bar"},
	{
...
var removedOptions = map[string]string{
	...
	"platform":               "goggo list --installer-platform <spec>",
	"language":               "goggo list --installer-language <spec>",
