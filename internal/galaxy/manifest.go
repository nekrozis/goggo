...
// server's answer decides the outcome (upstream behaviour as written, kept
// deliberately).
...
// define.
//
// It is exported because the download layer calls it directly
// (downloader.cpp:4622 expands a chunk's compressed md5 with it) and that layer
// is ported outside this package.
