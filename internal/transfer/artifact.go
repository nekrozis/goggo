...
// exists-skip: a logo or icon is re-fetched every run. The emit sink is a
// no-op — an image is not worth a progress surface; the caller reports the
// outcome as a structured artifact.
